# Sri Padmaraj Public School — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-sri-padmaraj-public-school/
- **Repo:** `shreekantha3/sindagi-sri-padmaraj-public-school` (branch `main` = source, `gh-pages` = deployed bundle)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-sri-padmaraj-public-school/'` for GitHub Pages project-site hosting.

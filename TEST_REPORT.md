# TEST REPORT — Sri Padmaraj Public School
> Tester: Senior Engg | Segment: CBSE school | Tier-4/5

## Build
- [ ] `npm run build` (pending)

## Static QA (generator asserts)
- Phone: MISSING → no tel: links by design | Maps embed (lazy iframe) + JSON-LD School schema + H1 + title<=60
- No lorem ipsum, no invented hours/prices/ratings

## Build result (2026-09-15)
- [x] `npm run build` PASS (vite 5.4.21, 0 warnings)
- dist: index 13.92 kB / CSS 11.85 kB / JS 1.17 kB — under perf budget
